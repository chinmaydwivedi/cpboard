  ...
  return (
    ...
    >
      <DialogContent
        ...
        className="flex max-h-[90vh] max-w-[calc(100%-2rem)] flex-col gap-0 overflow-hidden border border-border/70 bg-card/95 p-0 backdrop-blur-xl sm:max-w-xl"
        data-tour="whats-new-modal"
      >
        <div className="min-h-0 flex-1 overflow-y-auto bg-linear-to-br from-primary/15 via-card to-card p-5 sm:p-6">
        ...
        <DialogFooter className="mx-0 mb-0 shrink-0 border-t border-border/50 bg-card/95 p-5 sm:p-6">
          <Button
            type="button"
            variant="ghost"
